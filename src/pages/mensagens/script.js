const notifications = [
    {
      ...
      message: "Olá Thiago! Você sabia que agora novos parceiros do Ifood possuem benefícios de afiliados também!? É isso aí! De agora em diante você terá um link que, quando divulgado para novos potenciais parceiros Ifood, você recebe comissão recorrente se realizar o cadastro pelo seu link! Para habilitar seu link de afiliado, entre em contato",
      read: false,
    },
    {
      id: 2,
